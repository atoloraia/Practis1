...
public class AssignPractisSetsAndDueDatesModule {
  ...
  private final ElementsCollection itemContainer = $$("div[data-test='practisset-item-container']");
  private final ElementsCollection itemCheckbox = $$("input[data-test='practisset-item-checkbox']");
  ...
  private final ElementsCollection dueDateEditButton = $$("div[data-test='due-date-edit-button']");
