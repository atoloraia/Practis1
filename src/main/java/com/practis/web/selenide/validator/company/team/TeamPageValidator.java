...
public class TeamPageValidator {
    ...
    public static void assertEmptyTeamPage(final String teamName) {
        ...
        trainingTab()
                .getTrainingTeamMemberStatusColumns()
                .shouldBe(
                        exactText(
                                "Team Member Status\n"
                                        + "Not Started\n"
    ...
    /** Assert counters. */
    public static void assertCountersOnTeamPage(
            final String psCounter, final String usersCounter, final String teamLeaderCounter) {
