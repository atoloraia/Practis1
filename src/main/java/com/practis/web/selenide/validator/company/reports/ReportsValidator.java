...
public class ReportsValidator {
  ...
  public static void assertElementsOnReportsPage() {
    ...
    reportsPage().getPractisSetSummaryText().shouldBe(exactText("Shows more information about a particular practis set."));
    ...
    reportsPage().getTeamLeaderSummaryText().shouldBe(exactText("How engaged are Team Leaders in their learner's training."));
    ...
    reportsPage().getUserActivityText().shouldBe(exactText("Understand your team(s) progress on all their Practis Sets."));
