...
public class YouNeedMoreSeatsValidator {
    ...
    public static void assertYouNeedMoreSeatsPopUp() {
        ...
        youNeedMoreSeats()
                ...
                .shouldBe(
                        matchText(
                                "You can either modify the invitations here to a lower number,"
                                    + " find unaccepted invitations and revoke them, which will"
                                    + " free up some seats.\n"
                                    + "Alternatively, contact your Practis Support to request an"
                                    + " increase."));
