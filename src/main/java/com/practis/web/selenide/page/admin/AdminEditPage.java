...
public class AdminEditPage {
  ...
  private final SelenideElement userSettingsTitle = $("div[data-test='user-settings-page-title']");
  ...
  private final SelenideElement pictureText = $("div[data-test='user-profile-upload-description']");
