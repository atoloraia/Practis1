...
public class LogsPage {
    ...
    private final ElementsCollection companyEventRow =
            $$("tr[data-test='event-item-company-title']");
    ...
    private final ElementsCollection dateCreatedEventRow =
            $$("tr[data-test='date-created-column']");
    ...
    private final SelenideElement noEventsFilterIcon =
            $("div[data-test='no-filtered-events-icon']");
    private final SelenideElement noEventsFilterText =
            $("div[data-test='no-filtered-events-label']");
}
