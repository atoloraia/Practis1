...
public class ReportsPage {
  ...
  private final SelenideElement reportsTitle =
  ...
  private final SelenideElement practisSetSummaryTitle = $("input[data-test='practis-set-title']");
  ...
  private final SelenideElement teamLeaderSummaryIcon =
      $("span[data-test='practis-set-not-published-yet']");
  private final SelenideElement teamLeaderSummaryTitle = $("input[data-test='practis-set-title']");
  private final SelenideElement teamLeaderSummaryText = $("input[data-test='practis-set-title']");

  private final ElementsCollection excelText = $$("button[data-test='save-practis-set-as-draft']");
}
