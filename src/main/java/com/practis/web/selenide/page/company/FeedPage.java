...
public class FeedPage {
    ...
    private final SelenideElement accuracyChallengesTab =
            $("a[data-test='accuracy-nav-challenges']");
    ...
    private final SelenideElement accuracySelectAllCheckboxButton = $("td[data-test='table-cell']");
    private final SelenideElement accuracyUsersColumnText =
            $("th[data-test='accuracy-users-column']");
    private final SelenideElement accuracyTestColumnText =
            $("th[data-test='accuracy-test-column']");
