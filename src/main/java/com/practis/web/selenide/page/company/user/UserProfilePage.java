...
public class UserProfilePage {
  ...
  private final SelenideElement dueDateColumn =
      $("th[data-test='due-date-column']");
  private final SelenideElement progressColumn =
      $("th[data-test='progress-column']");
  private final SelenideElement accuracyColumn =
      $("th[data-test='accuracy-column']");
  private final SelenideElement trainingTimeColumn =
      $("th[data-test='training-time-column']");
  private final SelenideElement assignedColumn =
      $("th[data-test='assigned-column']");
  private final SelenideElement startedColumn =
      $("th[data-test='started-column']");
  private final SelenideElement lastTrainingColumn =
      $("th[data-test='last-training-column']");

  private final SelenideElement noPractisSetImage = $("div[data-test='no-user-practis-sets-icon']");
  private final SelenideElement noPractisSetText = $("div[data-test='no-user-practis-sets-label']");
}
