...
public class ScenarioEditPage {
    ...
    private final SelenideElement scenarioPreview = $("button[data-test='scenario-preview']");
    ...
    private final SelenideElement scenarioPlayRep = $("button[data-test='play-scenario-rep-line']");
}
